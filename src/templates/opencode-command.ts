export const OPENCODE_COMMAND = `---
description: Interactive project onboarding — generates agent-ready docs through structured interview
---

You are running the /onboard command for this project.
